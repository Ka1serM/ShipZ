...
public class SpielLaden extends GUI.ansichten.Ansicht {
    ...
    public SpielLaden() {
        ...
        zuruckButton.setOnAction(e -> wirfNaechsteAnsicht(GUI.Ansicht.HAUPTMENUE));
    ...
    private class SpielLadenEintrag extends HBox {
        ...
        private void feuerZuLadendesSpiel() {
            ...
            // Bumm
            gui.feuerEvent(Enums.GameAction.SPIEL_LADEN, "");
        }
        ...
        private void feuerZuLoeschendesSpiel() {
            ...
            // Bumm
            gui.feuerEvent(Enums.GameAction.SPIEL_LOESCHEN, "");
