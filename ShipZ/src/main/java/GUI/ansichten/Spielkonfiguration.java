...
public class Spielkonfiguration extends Ansicht {
     ...
     * 100% auf der Bar entsprechen 30% Flaeche auf dem Spielfeld
    ...
    /** Anzahl an Feldern im Spielfeld, berechnet aus Spielfeldbreite und -Hoehe */
    ...
    public Spielkonfiguration() {
        ...
        // -------------------- Presets --------------------
            HashMap<Enums.ShipTyp, Integer> schiffskonfiguration = new HashMap<>();
            schiffskonfiguration.put(Enums.ShipTyp.PATROL_BOAT, 1);
            schiffskonfiguration.put(Enums.ShipTyp.SUBMARINE, 1);
            schiffskonfiguration.put(Enums.ShipTyp.DESTROYER, 1);
            schiffskonfiguration.put(Enums.ShipTyp.BATTLESHIP, 1);
            schiffskonfiguration.put(Enums.ShipTyp.CARRIER, 1);
        ...
        // -------------------- Schiffsspinner --------------------
            ...
            // Standardschiffe
                ...
                // EINER
                SchiffSpinner einerSpinner = new SchiffSpinner(0,9,0, Enums.ShipTyp.PATROL_BOAT);
                ...
                // ZWEIER
                SchiffSpinner zweierSpinner = new SchiffSpinner(0,9,1, Enums.ShipTyp.SUBMARINE);
                ...
                // DREIER
                SchiffSpinner dreierSpinner = new SchiffSpinner(0,9,1, Enums.ShipTyp.DESTROYER);
                ...
                // VIERER
                SchiffSpinner viererSpinner = new SchiffSpinner(0,9,1, Enums.ShipTyp.BATTLESHIP);
                ...
                // FUENFER
                SchiffSpinner fuenferSpinner = new SchiffSpinner(0,9,1, Enums.ShipTyp.CARRIER);
     ...
     * wenn zu viele Schiffe im Spielfeld sind.
     */
     ...
     * bei welchen ein weiteres Schiff nicht mehr ins Spielfeld passt.
     */
    ...
    /**
     * Errechnet aus Spielfeldbreite und -Hoehe die Anzahl an Feldern im Spielfeld
     * */
    ...
    private void spielkonfigurationWerfen() {
        ...
        HashMap<Enums.ShipTyp, Integer> schiffszusammensetzung = new HashMap<>();
        for(SchiffSpinner spinner : this.alleSchiffSpinner) {
            Enums.ShipTyp typ = spinner.getTyp();
        ...
        // Bumm
        gui.feuerEvent(Enums.GameAction.SCHIFFSKONFIGURATION_ABRUFBAR, "");
    }
     ...
     */
    private void presetLaden(int spielfeldbreite, int spielfeldhoehe, HashMap<Enums.ShipTyp, Integer> schiffskonfiguration, boolean schiffsberuehrungErlaubt) {
