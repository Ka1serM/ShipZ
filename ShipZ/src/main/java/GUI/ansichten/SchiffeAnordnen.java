...
public class SchiffeAnordnen extends Ansicht {
    ...
    private Spielfeld anordnenAufSpielfeld;
     ...
     * @param anordnenAufSpielfeld Die Spielfeldseite auf der das Raster angezeigt und die Schiffe angeordnet werden sollen.
     */
    public SchiffeAnordnen(Spielfeld anordnenAufSpielfeld) {

        // IV setzen fuer aktualisieren()
        this.anordnenAufSpielfeld = anordnenAufSpielfeld;
        ...
        this.schlachtBeginnenButton.setOnMouseClicked(e -> {
            gui.feuerEvent(Enums.GameAction.SCHIFFE_FERTIG_PLATZIERT, "");
        });
    ...
    public void einrichten(Spielraster spielraster, String spielername, boolean schiffsberuehrungErlaubt) {
        ...
        if (this.anordnenAufSpielfeld == Spielfeld.RECHTS) {
