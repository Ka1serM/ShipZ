...
import Administration.Ship;
import SLURPH.GameStorage;
import SLURPH.GameState;
import SLURPH.GameMove;
import Administration.HighscoreItem;
import Administration.Board;
import SLURPH.Settings;
...
public class Main {
    ...
    public static GameMove collectGameState(Board player1Board, Board player2Board) {
    ...
    public static int calculatePoints(Board board) {
        int points = 0;
